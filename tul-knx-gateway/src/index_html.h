        ...
        <div class="grid">
            ...
            <section class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="info-row"><span data-i18n="knx.ipRouting">IP Routing:</span> <span id="knx_routing">-</span></div>
                    <div class="info-row">
        ...
        function updateStatus() {
            fetch('/api/status')
                ...
                .then(data => {
                    ...
                    if (data.knx_routing !== undefined)
                        document.getElementById('knx_routing').innerText = data.knx_routing ? t('knx.routingActive') : t('knx.routingOff');
